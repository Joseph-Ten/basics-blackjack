...
var winning_check = function (final_playerScore, computer_finalScore) {
  if (
    ...
    myOutputValue =
      "Your score is " + final_playerScore + " Computer's score is " + computer_finalScore + " <br><br> You have won!";
  } else if (
    (computer_finalScore > final_playerScore && computer_finalScore < 21) ||
    final_playerScore > 21
  ) {
    myOutputValue =
      "Your score is " + final_playerScore + " Computer's score is " + computer_finalScore + " <br><br> You have lost..";
  } else if (
    (computer_finalScore > 21 && final_playerScore > 21) ||
    computer_finalScore == final_playerScore
  ) {
    myOutputValue = "Your score is " + final_playerScore + " Computer's score is " + computer_finalScore + " <br><br> It's a draw! ";
  }
